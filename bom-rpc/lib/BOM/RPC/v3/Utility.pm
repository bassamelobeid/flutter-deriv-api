...
sub error_map {
    ...
    return {
        ...
        ResidentSelfDeclarationRequired => localize('Resident Self Declaration required for country.'),
        ...
        AlreadyVerified                  => localize('This account is already phone number verified'),
        NoAttemptsLeft                   => localize('Please wait for some time before requesting another OTP code'),
        FailedToGenerateOTP              => localize('Could not generate OTP, please try again in a few minutes'),
        InvalidOTP                       => localize('The OTP is not valid'),
        PhoneNumberVerificationSuspended => localize('Phone Number Verification is temporarily suspended'),
