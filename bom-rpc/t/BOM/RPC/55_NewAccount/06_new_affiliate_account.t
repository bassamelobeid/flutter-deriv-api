...
subtest 'new affiliate account signing up for CPA in non DIEL country' => sub {
    ...
    $rpc_ct->call_ok('affiliate_register_person', $params)
        ->has_error->error_code_is('InvalidResidence', 'Returns correct response when CPA selected in non-DIEL Country');
};
