...
subtest 'freezing funds disabled -> payout_created -> freezing funds enabled -> payout_inprogress' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(1);
    ok !$client->is_payout_freezing_funds_enabled, 'freezing funds is disabled';
    ...
    ok $client->is_payout_freezing_funds_enabled, 'freezing funds is enabled';
...
subtest 'freezing funds disabled -> payout_created -> freezing funds enabled -> payout_cancelled' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(1);
    ok !$client->is_payout_freezing_funds_enabled, 'freezing funds is disabled';
...
subtest 'freezing funds disabled -> payout_created -> freezing funds enabled -> payout_inprogress -> payout_rejected' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(1);
    ok !$client->is_payout_freezing_funds_enabled, 'freezing funds is disabled';
...
subtest 'freezing funds enabled -> payout_created -> freezing funds disabled -> payout_inprogress' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(0);
    ok $client->is_payout_freezing_funds_enabled, 'freezing funds is enabled';
...
subtest 'freezing funds enabled -> payout_created -> freezing funds disabled -> payout_cancelled' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(0);
    ok $client->is_payout_freezing_funds_enabled, 'freezing funds is enabled';
...
subtest 'freezing funds enabled -> payout_created -> freezing funds disabled -> payout_inprogress -> payout_rejected' => sub {
    BOM::Config::Runtime->instance->app_config->system->suspend->payout_freezing_funds(0);
    ok $client->is_payout_freezing_funds_enabled, 'freezing funds is enabled';
