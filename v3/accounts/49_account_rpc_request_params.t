...
is_deeply $authorize->{authorize}->{upgradeable_landing_companies}, ['maltainvest'], 'UK client can upgrade to IOM.';
...
is_deeply $authorize->{authorize}->{upgradeable_landing_companies}, ['maltainvest'], 'Existing MX client can upgrade to maltainvest.';
