...
test_sendrecv_params 'proposal/test_send.json', 'proposal/test_receive.json',
    ...
    '54.72', '54.72', '97.140';
test_sendrecv_params 'proposal/test_send.json', 'proposal/test_receive.json',
    '100', 'CALL', 'frxUSDJPY', '1', 'h', 'Win payout if USD/JPY is strictly higher than entry spot at 1 hour after contract start time.', '54.69',
    '54.69', '97.140';
test_sendrecv_params 'proposal/test_send.json', 'proposal/test_receive.json',
...
test_sendrecv_params 'proposal/test_send_single_barrier.json', 'proposal/test_receive_single_barrier.json',
    ...
    'Win payout if USD/JPY is strictly higher than entry spot plus  10 pips at 30 minutes after contract start time.', '48.78', '48.78', '97.140';
test_sendrecv_params 'proposal/test_send_single_barrier.json', 'proposal/test_receive_single_barrier.json',
    'CALL', 'frxUSDJPY', '1', 'h', '+0.01',
    'Win payout if USD/JPY is strictly higher than entry spot plus  10 pips at 1 hour after contract start time.', '49.80', '49.80', '97.140';
test_sendrecv_params 'proposal/test_send_single_barrier.json', 'proposal/test_receive_single_barrier.json',
    'CALL', 'frxUSDJPY', '2', 'h', '+0.01',
    'Win payout if USD/JPY is strictly higher than entry spot plus  10 pips at 2 hours after contract start time.', '51.07', '51.07', '97.140';
test_sendrecv_params 'proposal/test_send_single_barrier.json', 'proposal/test_receive_single_barrier.json',
