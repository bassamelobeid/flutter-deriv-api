...
test_sendrecv_params 'verify_email/test_send.json', 'verify_email/test_receive.json',
    'trader@binary.com', 'account_opening';
...
test_sendrecv_params 'api_token/test_send_create_read.json', 'api_token/test_receive_create_read.json',
    'test';
test_sendrecv_params 'api_token/test_send.json', 'api_token/test_receive_read.json',
...
test_sendrecv_params 'verify_email/test_send.json', 'verify_email/test_receive.json',
    'copier@binary.com', 'account_opening';
test_sendrecv_params 'new_account_virtual/test_send.json', 'new_account_virtual/test_receive.json',
...
test_sendrecv_params 'copy_start/test_send.json', 'copy_start/test_receive.json',
    $suite->get_stashed('api_token/api_token/tokens/0/token');
test_sendrecv_params 'copy_stop/test_send.json', 'copy_stop/test_receive.json',
    $suite->get_stashed('api_token/api_token/tokens/0/token');
