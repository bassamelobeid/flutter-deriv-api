...
fail_test_sendrecv_params 'active_symbols/test_send_lc.json', 'active_symbols/test_receive_lc.json',
    'costarica', 'forex', 'major_pairs';
fail_test_sendrecv 'asset_index/test_send.json', 'asset_index/test_receive_to_fail.json';
fail_test_sendrecv_params 'landing_company/test_send.json', 'landing_company/test_receive_de.json',
    'id';
fail_test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_costarica.json',
    'virtual';
...
test_sendrecv_params 'landing_company/test_send.json', "landing_company/test_receive_$_.json",
    $_ foreach qw( de id jp );

test_sendrecv_params 'landing_company_details/test_send.json', "landing_company_details/test_receive_$_.json",
    $_ foreach qw( costarica virtual iom japan malta maltainvest );
...
test_sendrecv_params 'active_symbols/test_send.json', 'active_symbols/test_receive_brief.json',
    'brief';
# test_sendrecv_params 'active_symbols/test_send.json', 'active_symbols/test_receive_full.json',
#     'full';

test_sendrecv_params 'active_symbols/test_send_lc.json', 'active_symbols/test_receive_lc.json',
    'japan', 'forex', 'major_pairs';
test_sendrecv_params 'active_symbols/test_send_lc.json', 'active_symbols/test_receive_lc.json',
    'malta', 'volidx', '.*';
test_sendrecv_params 'active_symbols/test_send_lc.json', 'active_symbols/test_receive_lc.json',
    'maltainvest', '(?!^volidx$)(^.*$)', '.*';
