...
sub create_underlying_db {
    ...
    $result->offerings_flyby(LandingCompany::Registry->get_default_company()->basic_offerings(BOM::Config::Runtime->instance->get_offerings_config));
    $result->offerings_flyby_all(
        LandingCompany::Registry->get_default_company()->basic_offerings(BOM::Config::Runtime->instance->get_offerings_config('buy', 1)));
