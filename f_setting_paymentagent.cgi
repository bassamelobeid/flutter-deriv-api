...
if ($whattodo eq 'show') {
    ...
    my $input_fields = {
        ...
        pa_max_withdraw    => $pa->max_withdraw,
        pa_min_withdraw    => $pa->min_withdraw,
    ...
    $pa->max_withdraw(request()->param('pa_max_withdraw') || 0);
    $pa->min_withdraw(request()->param('pa_min_withdraw') || 0);
