...
my $action_mapping = {
    ...
    track => {
        ...
        create_mt5_ib_technical_accounts                 => \&BOM::Event::Actions::MT5::create_mt5_ib_technical_accounts,
        ...
        payment_credit_deposit                           => \&BOM::Event::Services::Track::payment_credit_deposit,
        payment_debit_withdrawal                         => \&BOM::Event::Services::Track::payment_debit_withdrawal,
        payment_deposit_reversal                         => \&BOM::Event::Services::Track::payment_deposit_reversal,
        payment_withdrawal_reversal_event                => \&BOM::Event::Services::Track::payment_withdrawal_reversal_event,
