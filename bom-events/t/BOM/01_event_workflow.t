    ...
    cmp_deeply(
        ...
        bag(
            qw/email_statement sync_user_to_MT5
                ...
                crypto_withdrawal idv_configuration_disable_provider idv_configuration_enable_provider idv_configuration_requested idv_dynamic_settings_updated
                ...
                sync_user_to_CTRADER batch_payment/
        ),
    ...
    cmp_deeply(
        ...
        bag(
            qw/multiplier_hit_type multiplier_near_expire_notification multiplier_near_dc_notification
                ...
                request_change_email confirm_change_email verify_change_email account_reactivated payment_debit_withdrawal
                login transfer_between_accounts set_financial_assessment payment_deposit payment_credit_deposit
                ...
                trading_platform_investor_password_changed trading_platform_investor_password_change_failed create_mt5_ib_technical_accounts
                ...
                duplicated_document_account_closed phone_number_verification under_antifraud_investigation/
        ),
        'Correct number of actions that can be emitted'
    );
