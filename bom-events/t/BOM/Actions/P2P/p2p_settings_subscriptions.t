...
subtest 'subscribe to one country' => sub {
    ...
    BOM::Event::Actions::P2P::settings_updated({affected_countries => ['id']});
    ...
    BOM::Event::Actions::P2P::settings_updated({affected_countries => ['za']});
...
subtest 'subscribe to multiple countries' => sub {
    ...
    BOM::Event::Actions::P2P::settings_updated({affected_countries => ['id', 'za']});
