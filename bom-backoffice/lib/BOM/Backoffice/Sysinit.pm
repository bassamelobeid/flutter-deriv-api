...
my $permissions = {
    ...
    'f_app_management.cgi'                        => ['Marketing', 'IT'],
    ...
    'partners/set_partner_id.cgi'                 => ['Marketing'],
    'partners/select_partner_sidc.cgi'            => ['Marketing'],
    'partners/link_partner.cgi'                   => ['Marketing'],
    ...
    'partners/create_partner_mt5tech_account.cgi' => ['Marketing'],
    ...
    # Should have same access as f_clientloginid_edit.cgi
    'compute_virtual_status.cgi'          => ['CS',        'MarketingReadOnly', 'AccountsLimited', 'AccountsAdmin'],
    'client_poo_details.cgi'              => ['AntiFraud', 'CS'],
