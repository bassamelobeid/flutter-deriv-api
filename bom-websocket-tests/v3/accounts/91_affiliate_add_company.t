...
my %details = (
    ...
    country                 => "ml",
    company_name            => "Google",
    company_register_number => "132442312",
    currency                => "USD",
...
subtest 'new affiliate account for company' => sub {
    # create VR acc
    ...
    my $res = $t->await::affiliate_add_company(\%details, {timeout => 10});
    test_schema('affiliate_add_company', $res);
    is $res->{msg_type}, "affiliate_add_company";
