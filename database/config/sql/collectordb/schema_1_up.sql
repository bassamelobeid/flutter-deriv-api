...
CREATE USER MAPPING FOR postgres SERVER cr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR postgres SERVER mx  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR postgres SERVER mlt OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR postgres SERVER vr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR postgres SERVER mf  OPTIONS (user 'read', password 'hEWC2k7');
...
CREATE USER MAPPING FOR master_write SERVER cr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR master_write SERVER mx  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR master_write SERVER mlt OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR master_write SERVER vr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR master_write SERVER mf  OPTIONS (user 'read', password 'hEWC2k7');

CREATE USER MAPPING FOR write SERVER cr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR write SERVER mx  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR write SERVER mlt OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR write SERVER vr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR write SERVER mf  OPTIONS (user 'read', password 'hEWC2k7');

CREATE USER MAPPING FOR read SERVER cr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR read SERVER mx  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR read SERVER mlt OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR read SERVER vr  OPTIONS (user 'read', password 'hEWC2k7');
CREATE USER MAPPING FOR read SERVER mf  OPTIONS (user 'read', password 'hEWC2k7');
