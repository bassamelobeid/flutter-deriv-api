...
print "<br /><br /><table border=\"1\" cellpadding=\"3\">" . "<tr>"
  ...
  . "<td>LoginIDs on this list will not be able to log into their accounts - the system will say 'wrong loginID or password'.</td>" . "</tr>" . "<tr>"
...
my %form_action = ('oklogins' => $trusted_ok_login,);
