...
Check the remark (comment) of payments to find duplicate, used during doughflow validation
...
Check the remark of payment to find duplicate, used for manual deposit by payments team
