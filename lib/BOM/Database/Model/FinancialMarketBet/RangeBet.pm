...
sub _build_range_bet_record {
    my $self = shift;
    if ($self->financial_market_bet_record->can('range_bet') and $self->financial_market_bet_record->range_bet) {
        return $self->financial_market_bet_record->range_bet;
    } else {
...
sub save {
    ...
    $self->range_bet_record->financial_market_bet_id($self->financial_market_bet_record->id);
...
#    my $args = shift;
#
#    $self->_delete_orm_object({'record' => $self->range_bet_record});
