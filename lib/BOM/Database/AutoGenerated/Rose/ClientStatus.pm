...
__PACKAGE__->meta->setup(
    ...
    columns => [
        ...
        staff_name         => { type => 'varchar', length => 100 },
        reason             => { type => 'varchar', length => 1000 },
    ...
    foreign_keys => [
        ...
        client_status_code => {
            class       => 'BOM::Database::AutoGenerated::Rose::ClientStatusCode',
            key_columns => { status_code => 'status_code' },
        },
    ],
);
