    ...
    $app->plugin(
        'json_rpc_dispatcher' => {
            services => {
                ...
                '/send_ask'        => MojoX::JSON::RPC::Service->new->register('send_ask',        \&BOM::RPC::v3::TickStreamer::send_ask),
                '/get_bid'         => MojoX::JSON::RPC::Service->new->register('get_bid',         \&BOM::RPC::v3::TickStreamer::get_bid),
