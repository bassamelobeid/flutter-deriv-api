...
my $config = {
    errors => {
        ...
        TradingSuspendedSpecificHours => 'Trading on forex contracts with duration less than 5 hours is not available from [_2] to [_3]',
    ...
    longcodes => {
        ...
        coinauction                 => 'Binary [_1] to be sent to [2]',
