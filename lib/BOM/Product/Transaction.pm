...
sub _build_pricing_comment {
    ...
    my ($contract, $price, $action, $price_slippage, $requested_price) = @{$args}{'contract', 'price', 'action', 'price_slippage', 'requested_price'};
...
sub _validate_sell_pricing_adjustment {
    ...
    # set the requested price to be store in db
