...
sub _standard_barrier_option {
    ...
    return Math::Business::BlackScholesMerton::NonBinaries::standardbarrier($spot, $self->_stop_out_proxy, $exercise_price, $cash_rebate,
...
sub _american_binary_knockout {
    ...
    return Math::Business::BlackScholesMerton::Binaries::americanknockout($spot, $self->_stop_out_proxy, $self->_take_profit_proxy, $payout,
...
sub _double_knockout {
    ...
    return Math::Business::BlackScholesMerton::NonBinaries::doubleknockout($spot, $self->_stop_out_proxy, $self->_take_profit_proxy, $K, $args->{t},
