...
sub localizable_description {
    return +{
        daily                 => BOM::Product::Static::get_longcodes()->{expirymisse_daily},
        intraday              => BOM::Product::Static::get_longcodes()->{expirymisse_intraday},
        intraday_fixed_expiry => BOM::Product::Static::get_longcodes()->{expirymisse_intraday_fixed_expiry},
    };
}
