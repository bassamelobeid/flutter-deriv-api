...
sub localizable_description {
    return {
        dollar => 'Payout of [_1] [_2] for every point [_3] rises from entry level, with stop loss of [_6] [_4] and stop profit of [_6] [_5].',
        point =>
            'Payout of [_1] [_2] for every point [_3] rises from entry level, with stop loss of [plural,_4,%d point,%d points] and stop profit of [plural,_5,%d point,%d points].',
    };
}
