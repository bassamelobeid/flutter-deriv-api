...
sub _init {
    ...
    # Flush everything except contractgroups and underlyinggroups. This is because
    # UnitTestMarketData flushes Redis data but UnitTestDatabase adds the required
