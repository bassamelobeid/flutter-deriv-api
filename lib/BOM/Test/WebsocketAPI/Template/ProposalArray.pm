...
publish proposal_array => sub {
    ...
    return {
        sprintf(
            'PRICER_KEYS::["amount","1000","barriers",[%s],"basis","payout","contract_type",[%s],"country_code","%s","currency","%s","duration","%s","duration_unit","%s","landing_company","%s","price_daemon_cmd","proposal_array_item","proposal_array","1","skips_price_validation","1","subscribe","1","symbol","%s"]',
            ...
            price_daemon_cmd => 'proposal_array_item'
            },
    };
};
