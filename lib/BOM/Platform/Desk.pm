...
sub upload {
    ...
    my $address =
          $customer_info->{address_line_1} . ', '
        . $customer_info->{address_line_2} . ', '
        . $customer_info->{address_city} . ', '
        . $customer_info->{address_postcode} . ', '
        . $country;
    ...
    my $data = {
        ...
        title       => $customer_info->{salutation},
    ...
    if ($error) {
        ...
        if ($response->{'code'} == 422) {
            ...
            if ($total_entries) {
                ...
                my $json_update = {custom_fields => {loginid => $existing_loginid}};
                ...
                my $update_tx_error = $update_tx->{'message'};
