...
my $permissions = {
    ...
    'f_manager_history.cgi'             => ['CS', 'AccountsLimited', 'AccountsAdmin'],
    'f_statement_internal_transfer.cgi' => ['CS'],
    'f_manager_crypto_history.cgi'      => ['CS'],
    'f_manager_statement.cgi'           => ['CS', 'AccountsLimited', 'AccountsAdmin'],
    ...
    'quant/cfd_account_management.cgi'                                        => ['Quants',   'Compliance'],
