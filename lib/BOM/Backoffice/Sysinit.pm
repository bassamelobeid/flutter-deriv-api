...
my $permissions = {
    ...
    'batch_payments.cgi'             => ['Payments', 'Accounts_basic', 'Accounts_normal'],
    'f_makedcc.cgi'                  => ['Payments', 'Accounts_normal'],
    'f_makedcc_mt5_autotransfer.cgi' => ['Payments'],
    'f_manager.cgi'                  => ['Payments', 'Accounts_basic', 'Accounts_normal'],
    'f_manager_confodeposit.cgi'     => ['Payments', 'Accounts_basic', 'Accounts_normal'],
    ...
    'monthly_client_report.cgi'   => ['Accounts_basic', 'Accounts_normal', 'Marketing'],
    'monthly_payments_report.cgi' => ['Accounts_basic', 'Accounts_normal', 'Marketing'],
    'f_accountingreports.cgi'     => ['Accounts_basic', 'Accounts_normal', 'Marketing'],
    'aggregate_balance.cgi'       => ['Accounts_basic', 'Accounts_normal', 'Marketing'],
    'f_upload_ewallet.cgi'        => ['Accounts_basic', 'Accounts_normal', 'Marketing'],
    ...
    'f_client_comments.cgi'             => ['CS'],
    'f_clientloginid_newpassword.cgi'   => ['CS'],
    'f_client_affiliate_details.cgi'    => ['CS'],
    'affiliate_reputation_details.cgi'  => ['CS', 'Compliance'],
    'f_send_statement.cgi'              => ['CS'],
    'f_investigative.cgi'               => ['CS'],
    'f_makeclientdcc.cgi'               => ['CS'],
    'f_manager_history.cgi'             => ['CS', 'Accounts_basic', 'Accounts_normal'],
    'f_statement_internal_transfer.cgi' => ['CS'],
    'f_manager_crypto_history.cgi'      => ['CS'],
    'f_manager_statement.cgi'           => ['CS', 'Accounts_basic', 'Accounts_normal'],
    ...
    'f_dailyturnoverreport.cgi'   => ['Accounts', 'Accounts_basic', 'Accounts_normal', 'Quants', 'IT', 'Marketing'],
    ...
    'f_bbdl_scheduled_request_files.cgi'                                      => ['QuantsWrite'],
    'f_bbdl_upload.cgi'                                                       => ['QuantsWrite'],
    ...
    'quant/market_data_mgmt/update_accumulator_config.cgi'                    => ['Quants'],
    'quant/market_data_mgmt/update_vanilla_config.cgi'                        => ['Quants'],
    'quant/market_data_mgmt/update_turbos_config.cgi'                         => ['Quants'],
    'quant/market_data_mgmt/update_feed_config.cgi'                           => ['Quants'],
    ...
    'quant/pricing/f_dealer.cgi'                                              => ['QuantsWrite'],
    ...
    'quant/vanilla_risk_management.cgi'                                       => ['Quants'],
    ...
    'quant/cfd_account_management.cgi'                                        => ['Quants'],
