...
my $permissions = {
    ...
    'p2p_order_manage.cgi'      => ['P2PRead', 'P2PWrite', 'AntiFraud'],
    'p2p_advertiser_list.cgi'   => ['P2PRead', 'P2PWrite', 'AntiFraud'],
    'p2p_advertiser_manage.cgi' => ['P2PRead', 'P2PWrite', 'AntiFraud'],    # additional check in page for P2PWrite/AntiFraud for setting band level
    'p2p_dynamic_settings.cgi'        => ['P2PWrite',   'AntiFraud'],
    'p2p_payment_method_manage.cgi'   => ['P2PWrite',   'AntiFraud'],
    'p2p_advert_rates_manage.cgi'     => ['P2PWrite',   'AntiFraud'],
    'p2p_band_management.cgi'         => ['P2PWrite',   'AntiFraud'],
