...
my $permissions = {
    ...
    'f_bo_enquiry.cgi'                  => ['CS'],
    'f_clientloginid.cgi'               => ['CS', 'MarketingReadOnly'],
    'f_clientloginid_edit.cgi'          => ['CS', 'MarketingReadOnly'],
    ...
    'f_manager_crypto_history.cgi'      => ['CS', 'MarketingReadOnly'],
    ...
    'untrusted_client_edit.cgi'         => ['CS', 'MarketingReadOnly'],
