...
my %EVENT_PROPERTIES = (
    ...
    trading_platform_account_created        => [qw(first_name login account_id account_type market_type)],
    trading_platform_password_reset_request => [qw(first_name verification_url code)],
    trading_platform_password_changed       => [qw(first_name contact_url type mt5_logins dx_logins)],
    trading_platform_password_change_failed =>
        [qw(first_name contact_url type successful_mt5_logins successful_dx_logins failed_mt5_logins failed_dx_logins)],
