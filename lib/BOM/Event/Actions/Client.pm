...
async sub _send_report_not_clear_status_email {
    ...
    my $email_status =
        Email::Stuffer->from('no-reply@binary.com')->to('authentications@binary.com')->subject($email_subject)
        ->text_body(
...
async sub _send_poa_email {
    ...
    Email::Stuffer->from('no-reply@binary.com')->to('authentications@binary.com')->subject('New uploaded POA document for: ' . $client->loginid)
