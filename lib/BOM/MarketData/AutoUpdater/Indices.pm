...
sub _build_symbols_to_update {
    ...
    if ($market eq 'indices') {
        ...
        push @symbols_to_update,
            qw(USAAPL USAMZN USCT USFB USGE USGOOG USKO USMSFT USPFE USXOM UKBARC UKBATS UKGSK UKHSBA UKVOD DEALV DEBAYN DEDAI DESIE DEVOW AUANZ AUBHP AUCBA AUMQG AUQAN);
    }
