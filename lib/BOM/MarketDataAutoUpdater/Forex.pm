...
sub _build_symbols_to_update {
    ...
    my %skip_list =
        ...
        qw(frxBROUSD frxBROAUD frxBROEUR frxBROGBP frxXPTAUD frxXPDAUD frxAUDSAR frxXALUSD frxXNIUSD frxXPBUSD frxXZNUSD frxXCUUSD)
        );
...
sub _build_symbol_with_non_atm_offering {
    ...
    my @non_atm_symbol = LandingCompany::Registry->get_default_company()->basic_offerings(BOM::Config::Runtime->instance->get_offerings_config)
