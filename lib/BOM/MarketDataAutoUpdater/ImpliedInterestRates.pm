...
sub run {
    ...
    foreach my $sym (
        qw/BTC-USD BTC-EUR BTC-AUD BTC-JPY BTC-NZD BTC-CAD BTC-CHF BTC-GBP BTC-PLN BTC-NOK BTC-MXN BTC-SEK ETH-USD ETH-EUR ETH-AUD ETH-JPY ETH-NZD ETH-CAD ETH-CHF ETH-GBP ETH-PLN ETH-NOK ETH-MXN ETH-SEK LTC-USD LTC-EUR LTC-AUD LTC-JPY LTC-NZD LTC-CAD LTC-CHF LTC-GBP LTC-PLN LTC-NOK LTC-MXN LTC-SEK ETC-USD ETC-EUR ETC-AUD ETC-JPY ETC-NZD ETC-CAD ETC-CHF ETC-GBP ETC-PLN ETC-NOK ETC-MXN ETC-SEK/
        )
    {
