...
sub _get_pricing_parameter_from_IH_pricer {
    ...
    $pricing_parameters->{risk_markup} = {
        map { $_ => $risk_markup->peek_amount($_) // 0 }
            qw(economic_events_markup economic_events_volatility_risk_markup economic_events_spot_risk_markup intraday_historical_iv_risk quiet_period_markup vol_spread_markup intraday_eod_markup short_term_kurtosis_risk_markup historical_vol_markup),
