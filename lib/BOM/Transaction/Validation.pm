...
sub _validate_sell_pricing_adjustment {
    ...
    my $recomputed = $contract->is_binary ? $contract->bid_probability->amount : formatnumber('price', $contract->currency, $contract->bid_price);
...
sub _validate_trade_pricing_adjustment {
    ...
    my $recomputed = $contract->is_binary ? $contract->ask_probability->amount : formatnumber('price', $contract->currency, $contract->ask_price);
