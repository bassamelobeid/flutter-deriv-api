...
sub get_bid {
    ...
    try {
        ...
        my $contract_affected_by_missing_market_data = (not $contract->may_settle_automatically and not @{$contract->corporate_actions and $contract->missing_market_data}) ? 1 : 0;
