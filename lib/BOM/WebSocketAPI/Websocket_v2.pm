...
sub __handle {
    ...
    foreach my $dispatch (@dispatch) {
        ...
        DataDog::DogStatsd::Helper::stats_inc('websocket_api_v2.call.all', {tags => [$tag, "category:$dispatch->[0]"]});
        ...
        if ($client) {
            DataDog::DogStatsd::Helper::stats_inc('websocket_api_v2.authenticated_call.all', {tags => [$tag, $dispatch->[0], "loginid:$client->{loginid}"]});
        }
