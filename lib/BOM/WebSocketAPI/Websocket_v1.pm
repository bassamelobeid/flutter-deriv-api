...
sub __handle {
    ...
    my @dispatch = (
        ...
        [
            'payout_currencies',
            \&BOM::WebSocketAPI::v1::ContractDiscovery::payout_currencies, 0
        ],
        [
            'active_symbols', \&BOM::WebSocketAPI::v1::Symbols::active_symbols,
            0
        ],
        [
            'contracts_for',
            \&BOM::WebSocketAPI::v1::ContractDiscovery::contracts_for, 0
        ],
        [ 'offerings', \&BOM::WebSocketAPI::v1::Offerings::offerings, 0 ],
        [
            'trading_times', \&BOM::WebSocketAPI::v1::Offerings::trading_times,
            0
        ],
        [
            'buy', \&BOM::WebSocketAPI::v1::PortfolioManagement::buy,
            1,     'open_receipt'
        ],
        [
            'sell', \&BOM::WebSocketAPI::v1::PortfolioManagement::sell,
            1,      'close_receipt'
        ],
        [
            'portfolio',
            \&BOM::WebSocketAPI::v1::PortfolioManagement::portfolio, 1
        ],
    ...
    foreach my $dispatch (@dispatch) {
        ...
        stats_inc( 'websocket_api_v1.call.' . $dispatch->[0],
            { tags => [$tag] } );
        stats_inc( 'websocket_api_v1.call.all',
            { tags => [ $tag, $dispatch->[0] ] } );
        ...
        stats_inc( 'websocket_api_v1.authenticated_call.all',
