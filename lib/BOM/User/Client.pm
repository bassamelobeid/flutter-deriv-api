...
=item * C<currency> - (optional) A string representing  a 3 character currency as defined by ISO 4217 https://en.wikipedia.org/wiki/ISO_4217 or short codes for bitcoin currencies. .  If given this string this call will attempt to create an account from the Client if one does not yet exist.  
=back
