...
my $CLIENT_LIMITS_CONFIG = LoadFile(File::ShareDir::dist_file('Client-Account', 'client_limits.yml'));
...
sub new {
    my $class = shift;
    my $args = shift || die 'User::Client->new called without args';
...
sub get_payment_agent {
    ...
    my $pa   = bless $obj, 'User::Client::PaymentAgent';
    return $pa;
}

# return a (new or existing) writeable User::Client::PaymentAgent
