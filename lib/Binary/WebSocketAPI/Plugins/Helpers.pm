...
use Binary::WebSocketAPI::v3::Instance::Redis qw| ws_redis_master redis_pricer redis_feed_replica redis_transaction |;
...
sub register {
    ...
    for my $redis_name (qw(ws_redis_master redis_pricer redis_pricer_subscription redis_feed_replica redis_transaction)) {
        $app->helper(
            $redis_name => sub {
