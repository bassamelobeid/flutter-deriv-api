...
subtest 'BOM::Platform::CryptoCashier::AutoUpdatePayouts::Approve->connect_clientdb' => sub {
    subtest 'does not accept virtual broker codes' => sub {
        ...
        for my $bc (@virtual_broker_codes) {
            my $auto_reject_obj = BOM::Platform::CryptoCashier::AutoUpdatePayouts::Approve->new(broker_code => $bc);
