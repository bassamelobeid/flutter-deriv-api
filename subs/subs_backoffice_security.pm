...
sub DualControlCode_CS {
    ...
    my $a = uc(substr(BOM::Utility::Hash::md5(ucfirst("$clerk/$today $filetype")), 1, 5));

    my $b = uc(substr(BOM::Utility::Hash::md5(lcfirst("$password$clerk/$today $filetype$clientloginid" . $^T . $$)), 0, 5));

    my $c = uc(substr(BOM::Utility::Hash::md5(ucfirst($a . 'u' . $b)), 1, 5));
...
sub dual_control_code_for_file_content {
    ...
    my $a = uc(substr(BOM::Utility::Hash::md5(ucfirst("$clerk/$today $file_content")),                     1, 5));
    my $b = uc(substr(BOM::Utility::Hash::md5(lcfirst("$password$clerk/$today $file_content" . $^T . $$)), 0, 5));
    my $c = uc(substr(BOM::Utility::Hash::md5(ucfirst($a . 'u' . $b)),                                     1, 5));
...
sub DualControlCode {
    ...
    my $a = uc(substr(BOM::Utility::Hash::md5(ucfirst("$clerk/$today $amount$currency$transtype$clientloginid")),                     1, 5));
    my $b = uc(substr(BOM::Utility::Hash::md5(lcfirst("$password$clerk/$today $amount$currency$transtype$clientloginid" . $^T . $$)), 0, 5));
    my $c = uc(substr(BOM::Utility::Hash::md5(ucfirst($a . 'u' . $b)),                                                                1, 5));
    return $a . $b . $c;
}
...
sub ValidDualControlCode {
    ...
    my $goodc = uc(substr(BOM::Utility::Hash::md5(ucfirst($a . 'u' . $b)), 1, 5));
