...
use BOM::Database::DataMaper::Account;
...
sub get_trades_details {
    ...
    my $start_date = Date::Utility->new($args->{start_date});
    my $end_date = Date::Utility->new($args->{end_date});
