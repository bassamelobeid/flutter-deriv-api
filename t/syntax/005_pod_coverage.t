...
my $allowed_naked_packages = {
    ...
    'BOM::Product::Contract::PredefinedParameters'                => 12,
    'BOM::Product::ContractFinder::Basic'                         => 3,
    'BOM::Product::ContractFinder::MultiBarrier'                  => 1,
    ...
    'BOM::Product::Pricing::Engine::Intraday::Forex'              => 17,
...
my $ignored_packages = [
    'BOM::Product::Contract',
    'BOM::Product::ContractPricer',
];
