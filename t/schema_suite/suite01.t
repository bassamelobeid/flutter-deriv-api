...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json', '', '(USD|EUR|GBP|AUD|BTC|LTC|BCH|ETH|UST)', 9;
...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
    _get_stashed('authorize/stash/token'), '(USD|EUR|GBP|AUD|BTC|LTC|BCH|ETH|UST)', 9;
# ADMIN SCOPE CALLS (CR)
