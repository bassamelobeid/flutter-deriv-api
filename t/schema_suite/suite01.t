...
test_sendrecv_params 'landing_company/test_send.json', "landing_company/test_receive_$_.json",
   $_ foreach qw( ua fr br );

test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_costarica.json',
   'costarica';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_virtual.json',
   'virtual';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_iom.json',
   'iom';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_japan.json',
   'japan';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_japan_virtual.json',
   'japan-virtual';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_malta.json',
   'malta';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_maltainvest.json',
   'maltainvest';
test_sendrecv_params 'landing_company_details/test_send.json', 'landing_company_details/test_receive_error.json',
   'unknown';
...
test_sendrecv_params 'verify_email/test_send.json', 'verify_email/test_receive.json',
   'test-rpc@binary.com', 'account_opening';
...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
   _get_stashed('authorize/stash/token'), 'USD', 1;
test_sendrecv_params 'login_history/test_send.json', 'login_history/test_receive.json',
   _get_stashed('authorize/stash/token');
test_sendrecv_params 'get_settings/test_send.json', 'get_settings/test_receive_vrtc.json',
   'Zambia', 'zm',  _get_stashed('authorize/stash/token');
test_sendrecv_params 'get_account_status/test_send.json', 'get_account_status/test_receive.json',
   _get_stashed('authorize/stash/token');
test_sendrecv_params 'profit_table/test_send.json', 'profit_table/test_receive_error_unauth.json',
   '12345', 1420041600, 1514736000;
test_sendrecv_params 'profit_table/test_send.json', 'profit_table/test_receive.json',
   _get_stashed('authorize/stash/token'), 1420041600, 1514736000;
test_sendrecv_params 'statement/test_send.json', 'statement/test_receive_error_unauth.json',
   '12345';
test_sendrecv_params 'statement/test_send.json', 'statement/test_receive.json',
   _get_stashed('authorize/stash/token');
test_sendrecv_params 'portfolio/test_send.json', 'portfolio/test_receive_error_unauth.json',
   '12345';
test_sendrecv_params 'portfolio/test_send.json', 'portfolio/test_receive.json',
   _get_stashed('authorize/stash/token');
test_sendrecv_params 'balance/test_send.json', 'balance/test_receive_error_unauth.json',
   '12345';
test_sendrecv_params 'balance/test_send.json', 'balance/test_receive.json',
   _get_stashed('authorize/stash/token');

# TRADE SCOPE CALLS (VRTC)
test_sendrecv_params 'topup_virtual/test_send.json', 'topup_virtual/test_receive_error.json',
   _get_stashed('authorize/stash/token');
test_sendrecv_params 'buy/test_send.json', 'buy/test_receive.json',
   _get_stashed('new_account_virtual/oauth_token'), '99\\\\d{2}\\\\.\\\\d{2}';

# TESTS TO RETURN ERROR (VRTC)
test_sendrecv_params 'set_settings/test_send.json', 'set_settings/test_receive_error.json',
...
test_sendrecv_params 'api_token/test_send_create.json', 'api_token/test_receive_create.json',
   _get_stashed('authorize/stash/token'), 'test-rpc';
...
test_sendrecv_params 'buy/test_send.json', 'buy/test_receive_nobalance.json',
...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
   _get_stashed('authorize/stash/token'), '(USD|EUR|GBP|AUD|BTC|LTC|BCH|ETH)', 8;

# SUB ACCOUNT OPENING (CR)
$suite->set_allow_omnibus('new_account_real/client_id');
test_sendrecv_params 'new_sub_account/test_send.json', 'new_sub_account/test_receive.json',
   _get_stashed('new_account_real/oauth_token');
test_sendrecv_params 'new_sub_account/test_send_details.json', 'new_sub_account/test_receive.json',
   _get_stashed('new_account_real/oauth_token');
...
test_sendrecv_params 'get_financial_assessment/test_send.json', 'get_financial_assessment/test_receive.json',
   _get_stashed('new_account_real/oauth_token'),_get_stashed('set_financial_assessment/score');
test_sendrecv_params 'set_settings/test_send.json', 'set_settings/test_receive.json',
   _get_stashed('new_account_real/oauth_token');
test_sendrecv_params 'set_self_exclusion/test_send.json', 'set_self_exclusion/test_receive.json',
   _get_stashed('new_account_real/oauth_token');

# READ SCOPE CALLS (CR)
test_sendrecv_params 'get_self_exclusion/test_send.json', 'get_self_exclusion/test_receive.json',
   _get_stashed('new_account_real/oauth_token');
...
test_sendrecv_params 'cashier_password/test_send.json', 'cashier_password/test_receive.json',
   _get_stashed('new_account_real/oauth_token'), '0';
...
test_sendrecv_params 'cashier/test_send_deposit.json', 'cashier/test_receive_error.json',
   _get_stashed('new_account_real/oauth_token');
test_sendrecv_params 'verify_email/test_send.json', 'verify_email/test_receive.json',
   'test-rpc@binary.com', 'payment_withdraw';
...
test_sendrecv_params 'cashier_password/test_send.json', 'cashier_password/test_receive.json',
   _get_stashed('new_account_real/oauth_token'), '1';
...
test_sendrecv_params 'reality_check/test_send.json', 'reality_check/test_receive.json',
   _get_stashed('new_account_maltainvest/oauth_token');
