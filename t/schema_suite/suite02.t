...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
   _get_stashed('authorize/stash/token'), '(USD|GBP)', 2;
...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
   _get_stashed('authorize/stash/token'), '(GBP)', 1;

test_sendrecv_params 'cashier/test_send_deposit.json', 'cashier/test_receive_ukgc_error.json',
   _get_stashed('new_account_real/oauth_token');

# ADMIN SCOPE CALLS (MX)
test_sendrecv_params 'tnc_approval/test_send_ukgc.json', 'tnc_approval/test_receive.json',
   _get_stashed('new_account_real/oauth_token');
...
test_sendrecv_params 'cashier/test_send_deposit.json', 'cashier/test_receive_max_turnover.json',
   _get_stashed('new_account_real/oauth_token');
...
# on qa and test
# &BOM::RPC::v3::Accounts::set_self_exclusion({client=>Client::Account->new({loginid => _get_stashed('new_account_real/client_id')}), args=>{max_30day_turnover=>1000}})
# test_sendrecv_params 'cashier/test_send_deposit.json', 'cashier/test_receive_currency_error.json',
#     _get_stashed('new_account_real/oauth_token');
...
test_sendrecv_params 'payout_currencies/test_send.json', 'payout_currencies/test_receive.json',
   _get_stashed('authorize/stash/token'), 'JPY', 1;

reset_app;

test_sendrecv_params 'ticks/test_send.json', 'ticks/test_receive.json',
   'R_50';
test_sendrecv_params 'ticks/test_send.json', 'ticks/test_receive_error.json',
   'invalid_symbol';
