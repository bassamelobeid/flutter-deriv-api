...
BEGIN { use_ok('Binary::WebSocketAPI::v3::Instance::Redis', qw| redis_pricer redis_pricer_shared ws_redis_master check_connections |); }
...
my $server_ref3 = redis_pricer_shared;
...
my $server_ref4 = redis_pricer_shared;
