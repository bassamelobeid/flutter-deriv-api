...
my $allowed_naked_packages = {
    ...
    'Binary::WebSocketAPI::v3::SubscriptionManager' => 5,
    'Binary::WebSocketAPI::v3::Subscription' => 4,
    'Binary::WebSocketAPI::v3::Instance::Redis' => 8,
    'Binary::WebSocketAPI::v3::Wrapper::P2P' => 2,
    'Binary::WebSocketAPI::v3::Wrapper::System' => 11,
    'Binary::WebSocketAPI::v3::Wrapper::Transaction' => 7,
    'Binary::WebSocketAPI::v3::Wrapper::Accounts' => 4,
    'Binary::WebSocketAPI::v3::Wrapper::Streamer' => 6,
    'Binary::WebSocketAPI::v3::Wrapper::Pricer' => 12,
    ...
    'Binary::WebSocketAPI::v3::Subscription::Transaction' => 7,
    'Binary::WebSocketAPI::v3::Subscription::Feed' => 2,
    'Binary::WebSocketAPI::v3::Subscription::Pricer' => 7,
    'Binary::WebSocketAPI::v3::Subscription::Pricer::ProposalArray' => 2,
    'Binary::WebSocketAPI::v3::Subscription::Pricer::Proposal' => 1,
    'Binary::WebSocketAPI::v3::Subscription::Pricer::ProposalOpenContract' => 1,
    'Binary::WebSocketAPI::v3::Subscription::Pricer::ProposalArrayItem' => 2,
