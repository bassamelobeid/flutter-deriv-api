...
subtest 'sell ads reversible balance' => sub {
    ...
    delete $advertiser->{_p2p_advertiser_cached};
    cmp_ok $advertiser->p2p_balance, '==', $advertiser->{client}->account->balance, 'extra_sell_amount increases p2p_balance no higher than account balance';
};
...
subtest 'buy ads reversible methods' => sub {
    ...
    $client->{client}->payment_doughflow(
