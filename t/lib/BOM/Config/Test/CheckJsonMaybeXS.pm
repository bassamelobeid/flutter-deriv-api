package BOM::Config::Test::CheckJsonMaybeXS;

=head1 NAME

BOM::Config::Test::CheckJsonMaybeXS - The test to check if L<JSON::MaybeXS> return a L<Cpanel::JSON::XS> object when we load our modules.
...
We need to make sure in our code L<JSON::MaybeXS> will always return `Cpanel::MaybeXS::JSON` at any time.

This module is also under bom-test. This copy is here because bom-config can't depend on bom-test.
