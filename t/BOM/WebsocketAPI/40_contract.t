...
## devbox we want live test b/c couchdb is good
if ($ENV{TRAVIS}) {
    require BOM::Test::Data::Utility::FeedTestDatabase;
    BOM::Test::Data::Utility::FeedTestDatabase->import(':init');
    require BOM::Test::Data::Utility::UnitTestCouchDB;
    BOM::Test::Data::Utility::UnitTestCouchDB->import(':init');
    require BOM::Test::Data::Utility::UnitTestRedis;
    BOM::Test::Data::Utility::UnitTestRedis->import('initialize_realtime_ticks_db');
