...
ok !$stash->{account_id},           'Should remove account_id from stash';
ok !$stash->{country},              'Should remove country from stash';
ok !$stash->{currency},             'Should remove currency from stash';
ok !$stash->{landing_company_name}, 'Should remove landing_company_name from stash';
