...
use Moose;
use lib qw(/home/git/regentmarkets/bom-product/t/BOM/Product);
use Date::Utility;
...
sub run_dataset {
    ...
    my $merlin_csv  = '/home/git/regentmarkets/bom-product/t/BOM/Product/Benchmark/csv/merlin/COMPLETE.csv';
