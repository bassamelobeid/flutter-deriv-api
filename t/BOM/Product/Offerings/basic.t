...
subtest 'get_offerings_with_filter' => sub {
    ...
    eq_or_diff(
        ...
        [sort qw(CALL CALLE PUT EXPIRYRANGE EXPIRYRANGEE EXPIRYMISS ONETOUCH LBFIXEDCALL LBFIXEDPUT LBFLOATCALL LBFLOATPUT LBHIGHLOW NOTOUCH RANGE UPORDOWN PUTE)],
