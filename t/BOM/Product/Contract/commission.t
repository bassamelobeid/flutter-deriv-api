...
subtest 'payout' => sub {
    ...
    $mocked->mock('model_markup', Math::Util::CalculatedValue::Validatable->new({
            name        => 'model_markup',
...
subtest 'stake' => sub {
    ...
    $mocked->mock('ask_probability', Math::Util::CalculatedValue::Validatable->new({
    ...
    my $min_total_markup = 0.02 / $payout;
    $mocked->mock('total_markup', Math::Util::CalculatedValue::Validatable->new({
            name        => 'total_markup',
