...
subtest 'tick expiry' => sub {
    subtest 'ASIAND - exit tick higher than average of ticks will be settled as loss' => sub {
    ...
    subtest 'ASIAND - exit tick equal to average of ticks will be settled as loss' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100,   $now->epoch + 1, $symbol],
    ...
    subtest 'ASIAND - exit tick lower to average of ticks will be settled as win' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100,     $now->epoch + 1, $symbol],
