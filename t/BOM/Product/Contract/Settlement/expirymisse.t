...
subtest 'intraday' => sub {
    subtest 'EXPIRYMISSE - not expired 1 second before expiry' => sub {
        my $c = produce_contract({%$args, date_pricing => $args->{date_start}->plus_time_interval($args->{duration})->minus_time_interval('1s')});
        ok !$c->is_expired, 'not expired';
    };

    subtest 'EXPIRYMISSE - date_pricing == date_expiry with inconsistent exit tick' => sub {
    ...
    subtest 'EXPIRYMISSE - date_pricing == date_expiry with consistent exit tick lower than low barrier = full payout' => sub {
    ...
    subtest 'EXPIRYMISSE - date_pricing == date_expiry with consistent exit tick equals to low barrier = full payout' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100,   $now->epoch + 1,                         $symbol],
    ...
    subtest 'EXPIRYMISSE - date_pricing == date_expiry with consistent exit tick higher than high barrier = full payout' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100,    $now->epoch + 1,                         $symbol],
    ...
    subtest 'EXPIRYMISSE - date_pricing == date_expiry with consistent exit tick equals to high barrier = full payout' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100,    $now->epoch + 1,                         $symbol],
    ...
    subtest 'EXPIRYMISSE - date_pricing == date_expiry with consistent exit tick in between the high barrier and low barrier = zero payout' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100, $now->epoch + 1,                         $symbol],
...
subtest 'multiday' => sub {
    subtest 'EXPIRYMISSE - expired but no OHLC data' => sub {
        BOM::Test::Data::Utility::FeedTestDatabase::flush_and_create_ticks(
            [100, $now->epoch + 1,                                                 $symbol],
    ...
    subtest 'EXPIRYMISSE - expired with OHLC data' => sub {
