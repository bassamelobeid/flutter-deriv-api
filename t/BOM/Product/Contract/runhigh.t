...
subtest 'runhigh - probability check' => sub {
...
subtest 'runhigh - expiration check' => sub {
...
subtest 'runhigh - shortcode & longcode' => sub {
    ...
    is_deeply(
        $c->longcode,
        [
            'Win payout if [_1] rises successively for [plural,_3,%d tick, %d ticks] after the entry spot.',
            ['Volatility 100 1Hz'], ['first tick'], [5], ['entry spot']
        ],
        'longcode matches'
    );
