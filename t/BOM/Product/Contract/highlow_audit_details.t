...
subtest 'tick highlow' => sub {
    ...
    lives_ok {
        ...
        my $expected = $json->decode(
            '{"all_ticks":[{"tick":"100.00","epoch":1425945600,"flag":"highlight_time","name":["Start Time"]},{"tick":"100.01","epoch":1425945601,"flag":"highlight_tick","name":["Entry Spot"]},{"tick":"100.02","epoch":1425945602},{"epoch":1425945603,"tick":"100.03"},{"tick":"100.04","epoch":1425945604},{"name":["[_1] and [_2]",["[_1] and [_2]","End Time","Exit Spot"],"Highest Spot"],"flag":"highlight_tick","epoch":1425945605,"tick":"100.10"}]}'
        );
