...
is roundnear(0.0001, $c->theo_probability->amount), 0.1537, 'correct bs probability for FX contract';
...
like $c->pricing_engine_name, qr/VannaVolga/, 'VV engine selected';
is roundnear(0.0001, $c->theo_probability->amount), 0.1053, 'correct bs probability for FX contract';
...
like $c->pricing_engine_name, qr/VannaVolga/, 'VV engine selected';
is roundnear(0.0001, $c->theo_probability->amount), 0.6241, 'correct bs probability for indices contract';
...
like $c->pricing_engine_name, qr/VannaVolga/, 'VV engine selected';
is roundnear(0.0001, $c->theo_probability->amount), 0.2154, 'correct bs probability for indices contract';
