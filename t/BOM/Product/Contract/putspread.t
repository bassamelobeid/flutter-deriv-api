...
subtest 'config' => sub {
    ...
    is $c->longcode->[0], 'Win up to [_7] [_6] if [_1]\'s exit tick is between [_4] and [_5] or [_7] [_6] if it falls below [_5] at [_3] after [_2].';
