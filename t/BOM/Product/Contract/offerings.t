...
subtest 'underlying symbols' => sub {
    my %expected = (
        ...
        stocks      => [
            qw(USCAT USGLDSCH USMCDON USMA USBRKSHR USBNG USIBM USALIBA USPEP USEA USJNJ USAMX USPG UKBP UKRIO UKSTAN UKLLOY UKTSCO DEBMW DENOT DESAP DEDBK DEAIR INMARUTI INRIL INTATAMOTORS INTATASTEEL INBHARTIARTL USAAPL USAMZN USCT USFB USGOOG USMSFT USXOM UKBARC UKBATS UKHSBA DEALV DEDAI DESIE )
        ],
        indices => [
