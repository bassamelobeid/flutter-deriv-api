...
subtest 'underlying symbols' => sub {
    my %expected = (
        ...
        indices => [
            qw( AEX AS51 BFX BSESENSEX30 DFMGI FCHI GDAXI HSI JCI N225 OBX SPC SSMI STI TOP40 ISEQ OTC_AEX OTC_AS51 OTC_BFX OTC_BIST100 OTC_BSESENSEX30 OTC_DJI OTC_FCHI OTC_FTSE OTC_GDAXI OTC_HSI OTC_IXIC OTC_N225 OTC_SPC)
        ],
