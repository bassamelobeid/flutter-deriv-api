...
subtest "predefined trading_period" => sub {
    ...
    my %expected_trading_period = (
        call_intraday => {
            ...
            date_start => [
                1441324800, 1441324800, 1441324800, 1441324800, 1441324800, 1441324800, 1441381500, 1441381500,
                1441374300, 1441385100, 1441377900, 1441377900, 1441370700
            ],
        },
        range_daily => {
    ...
    my %expected_barriers = (
        call_intraday => {
            available_barriers => [
                ...
                1.15521, 1.15661, 1.15501, 1.15681, 1.15451, 1.15731, 1.15351, 1.15831, 1.15151, 1.16031,1.15591
            ],
            barrier => 1.15591,
        },
        range_daily => {
