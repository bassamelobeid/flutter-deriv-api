...
subtest 'volsurfaces become old and invalid' => sub {
    ...
    my $volsurface = BOM::Test::Data::Utility::UnitTestMD::create_doc(
        'volsurface_moneyness',
        {
            symbol         => 'GDAXI',
    ...
    BOM::Test::Data::Utility::UnitTestMD::create_doc('correlation_matrix', {recorded_date => Date::Utility->new($bet_params->{date_pricing})});
...
subtest 'invalid start times' => sub {
    ...
    $volsurface = BOM::Test::Data::Utility::UnitTestMD::create_doc(
        'volsurface_moneyness',
        {
            symbol         => 'GDAXI',
...
subtest 'invalid lifetimes.. how rude' => sub {
    ...
    $bet_params->{barrier}      = 'S10P';
    $bet                        = produce_contract($bet_params);
    BOM::Test::Data::Utility::UnitTestMD::create_doc('correlation_matrix', {recorded_date => Date::Utility->new($bet_params->{date_start})});
