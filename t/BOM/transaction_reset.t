...
subtest 'buy a bet', sub {
    ...
    lives_ok {
        ...
        subtest 'transaction row', sub {
            ...
            is $trx->{amount} + 0,              -31.82,       'amount';
            is $trx->{balance_after} + 0,       5000 - 31.82, 'balance_after';
        ...
        subtest 'fmb row', sub {
            ...
            like $fmb->{remark}, qr/\btrade\[31\.82000\]/, 'remark';
