...
subtest 'buy MULTUP', sub {
    lives_ok {
        ...
        subtest 'chld row', sub {
            ...
            is $chld->{'stop_loss_amount'},     undef, 'stop_loss_amount is undef';
            ...
            is $chld->{'stop_out_amount'} + 0, -100, 'stop_out_amount is -100';
            ...
            is $chld->{'take_profit_amount'},      undef,  'take_profit_amount is undef';
...
subtest 'buy MULTUP with take profit', sub {
    lives_ok {
        ...
        subtest 'chld row', sub {
            ...
            is $chld->{'stop_out_basis_spot'},     '100.00', 'stop_out_basis_spot is 100.00';
            cmp_ok $chld->{'stop_out_order_date'}, "eq",   $fmb->{start_time}, 'stop_out_order_date is correctly set';
            is $chld->{'take_profit_amount'},      5,  'take_profit_amount is 5';
