...
subtest 'get_combined_realtime' => sub {
    ...
    subtest 'call with data at t and now at t + 86400' => sub {
        ...
        subtest 'Inverted' => sub {
            my $underlying = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxJPYUSD'}]);
...
subtest 'next_tick_after' => sub {
    ...
    subtest 'call with no data' => sub {
        subtest 'Direct' => sub {
            my $underlying = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxGBPAUD'}]);
        ...
        subtest 'Inverted' => sub {
            my $underlying = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxAUDGBP'}]);
...
subtest 'tick_at' => sub {
    ...
    my $test_time           = Date::Utility->new('2012-09-28 20:59:59');
    my $underlying          = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxAUDJPY'}]);
    my $inverted_underlying = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxJPYAUD'}]);
...
subtest 'tick_at scenarios' => sub {
    my $underlying = new_ok('Quant::Framework::Underlying' => [{symbol => 'frxEURGBP'}]);
