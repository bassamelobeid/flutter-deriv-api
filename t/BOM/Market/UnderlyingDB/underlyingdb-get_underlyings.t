...
eq_or_diff [sort keys %{Finance::Contract::Category->get_all_contract_categories}],
    [sort qw(callput endsinout touchnotouch staysinout asian digits vanilla lookback reset runs highlowticks callputspread callputequal multiplier)],
...
my @ul_indices_on_flash =
    qw(OTC_AEX OTC_AS51 OTC_DJI OTC_FCHI OTC_FTSE OTC_GDAXI OTC_HSI OTC_IBEX35 OTC_N225 OTC_NDX OTC_SPC OTC_SSMI OTC_SX5E);
cmp_bag [
...
subtest "sub market related" => sub {
    ...
    my @ul_random = qw(1HZ100V 1HZ10V 1HZ25V 1HZ50V 1HZ75V R_10 R_100 R_25 R_50 R_75);
    eq_or_diff [
        sort $udb->get_symbols_for(
            market            => 'synthetic_index',
