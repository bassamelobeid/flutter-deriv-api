...
subtest 'different language' => sub {
    ...
    subtest 'POI spanish' => sub {
        ...
        cmp_deeply $r_args{properties},
            {
            lang         => 'ES',
            title        => 'No pudimos verificar su cuenta',
            poi_reason   => 'expired',
            first_name   => 'bRaD',
            poi_subtitle => [
                "Visite su perfil para verificar/autentificar su cuenta. Env\x{ed}e un documento v\x{e1}lido, como el pasaporte, la licencia de conducir o el documento nacional de identidad, con los siguientes requisitos:"
            ],
            loginid    => 'CR10000',
            poi_layout => [
                'lleva su nombre que coincide con su perfil de Deriv',
                "muestra la fecha de emisi\x{f3}n y / o vencimiento (si corresponde)",
                'muestra tu fecha de nacimiento completa',
                'muestra su foto'
            ],
            poi_title => 'Su prueba de identidad ha expirado.',
            brand     => 'deriv',
            is_eu     => 0
            },
            'event properties are ok';
    ...
    subtest 'POA spanish' => sub {
        ...
        cmp_deeply $r_args{properties},
            {
            poa_subtitle => [
                "Visite su perfil para verificar / autenticar su cuenta. Env\x{ed}e un documento claro y legible, como un extracto bancario, una factura de servicios p\x{fa}blicos o una declaraci\x{f3}n jurada, con los siguientes requisitos:"
            ],
            poa_reason => 'old',
            brand      => 'deriv',
            lang       => 'ES',
            ...
            is_eu      => 0,
            poa_title  => "Su prueba de domicilio no est\x{e1} actualizada.",
            title      => 'No pudimos verificar su cuenta',
            first_name => 'bRaD'
            },
            'event properties are ok';
