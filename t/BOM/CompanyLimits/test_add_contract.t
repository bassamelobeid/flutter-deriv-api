...
subtest 'Key Combinations matching test', sub {
    ...
    $redis = BOM::Config::RedisTransactionLimits::redis_limits_write($cr_cl->landing_company);
    ...
    my $expected_keys = [
        'tn,R_50,+,digits', 'tn,R_50,+,+', 'tn,+,volidx,digits', 'tn,+,volidx,+', 'tn,+,+,digits', 'tn,+,+,+',
        't+,R_50,+,digits', 't+,R_50,+,+', 't+,+,volidx,digits', 't+,+,volidx,+', 't+,+,+,digits', 't+,+,+,+',
        '+n,R_50,+,digits', '+n,R_50,+,+', '+n,+,volidx,digits', '+n,+,volidx,+', '+n,+,+,digits', '+n,+,+,+',
        '++,R_50,+,digits', '++,R_50,+,+', '++,+,volidx,digits', '++,+,volidx,+', '++,+,+,digits', '++,+,+,+',
...
subtest 'Different currencies', sub {
    ...
    $redis = BOM::Config::RedisTransactionLimits::redis_limits_write($cr_usd->landing_company);
