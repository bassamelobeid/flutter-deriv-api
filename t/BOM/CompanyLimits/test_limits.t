...
subtest '_encode_limit and _decode_limit', sub {
    ...
    $encoded = BOM::CompanyLimits::Limits::_encode_limit(4, 2, 3, 4, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504);
    @decoded = BOM::CompanyLimits::Limits::_decode_limit($encoded);
    is_deeply (\@decoded, [4, 2, 3, 4, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504], 'there is four type of limit, so need to specify the 3 offset and all the remaining limits');
};
...
subtest '_extract_limit_by_group and _collapse_limit_by_group', sub {
    ...
    is_deeply ($extracted, {GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP => [10000, 1561801504, 1561801810, 559, 1561801504, 1961801810], GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => [30, 1261801504, 1961801810]}, '');
    ...
    $extracted = BOM::CompanyLimits::Limits::_extract_limit_by_group(4, 2, 3, 4, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504);
    is_deeply ($extracted, {GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP => [10000, 1561801504, 1561801810, 559, 1561801504, 1961801810], GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => [30, 1261801504, 1961801810], GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP => [700, 1261801504, 2061801504],GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS => [] }, '');
    @collapsed = BOM::CompanyLimits::Limits::_collapse_limit_by_group($extracted);
    is_deeply (\@collapsed, [4, 2, 3, 4, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504], '');
    ...
    is_deeply ($extracted, {GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP => [10000, 1561801504, 1561801810], GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => [559, 1561801504, 1961801810], GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP => [30, 1261801504, 1961801810],GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS => [700, 1261801504, 2061801504]}, '');
    @collapsed = BOM::CompanyLimits::Limits::_collapse_limit_by_group($extracted);
    ...
    is_deeply ($extracted, {GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP => [10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504], GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => [], GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP => [],GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS => []}, '');
    @collapsed = BOM::CompanyLimits::Limits::_collapse_limit_by_group($extracted);
    is_deeply (\@collapsed, [4, 4, 4, 4, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504], '');

};

my $mock_redis = Test::MockModule->new('RedisDB');
subtest '_get_decoded_limit', sub {
    $mock_redis->mock(hget => sub { return BOM::CompanyLimits::Limits::_encode_limit(4, 1, 2, 3, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504); });
    my $decoded = BOM::CompanyLimits::Limits::_get_decoded_limit('forex,,,t');
    is_deeply ($decoded, [4, 1, 2, 3, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810, 700, 1261801504, 2061801504], '');
