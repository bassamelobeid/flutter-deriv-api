...
subtest '_encode_limit and _decode_limit', sub {
    ...
    $encoded =
        BOM::CompanyLimits::Limits::_encode_limit(4, 3, 4, 2, 10000, 1561801504, 1561801810, 559, 1561801504, 1961801810, 30, 1261801504, 1961801810,
...
subtest '_extract_limit_by_group and _collapse_limit_by_group', sub {
    ...
    is_deeply(
        $extracted,
        {
            ...
            GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => undef,
            GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS  => undef,
            GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS  => undef
        },
        ''
    );
    ...
    is_deeply(
        $extracted,
        {
            ...
            GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS  => [30,    1261801504, 1961801810],
    ...
    is_deeply(
        $extracted,
        {
            GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP          => undef,
            GLOBAL_POTENTIAL_LOSS_UNDERLYINGGROUP_DEFAULTS => undef,
            GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS  => undef,
            GLOBAL_REALIZED_LOSS_UNDERLYINGGROUP_DEFAULTS  => undef
        },
