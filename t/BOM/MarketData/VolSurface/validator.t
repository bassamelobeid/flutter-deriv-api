...
BOM::Test::Data::Utility::UnitTestMD::create_doc('currency', {symbol => $_}) for (qw(USD EUR-USD USD-EUR));
...
subtest 'Unit test tools.' => sub {
    ...
    my $sample_surface = BOM::Test::Data::Utility::UnitTestMD::create_doc(
        'volsurface_delta',
        {
            symbol        => 'frxEURUSD',
            surface       => \%surface_data,
...
subtest _check_age => sub {
    ...
    my $sample   = BOM::Test::Data::Utility::UnitTestMD::create_doc(
        'volsurface_delta',
        {
            symbol        => 'frxEURUSD',
            surface       => \%surface_data,
    ...
    $sample = BOM::Test::Data::Utility::UnitTestMD::create_doc(
        'volsurface_delta',
        {
            symbol        => 'frxEURUSD',
            surface       => \%surface_data,
