...
subtest 'allow_paymentagent_withdrawal' => sub {
    ...
    subtest '1- No deposits or PA is the only deposit method -> payment agent withdrawal allowed' => sub {
        ...
        $allow_withdraw = $client_usd->allow_paymentagent_withdrawal;
    ...
    subtest '2- visa - CFT NOT Blocked - ' => sub {
        ...
        $allow_withdraw = $client_usd1->allow_paymentagent_withdrawal;
    ...
    subtest '4- MasterCard' => sub {
        ...
        $allow_withdraw = $client_usd2->allow_paymentagent_withdrawal;
    ...
    subtest '6- Reversible - Acquired (NOT ZingPay) - CFT NOT Blocked' => sub {
        ...
        $allow_withdraw = $client_usd3->allow_paymentagent_withdrawal;
    ...
    subtest '8- Reversible - ZingPay' => sub {
        ...
        $allow_withdraw = $client_usd4->allow_paymentagent_withdrawal;
    ...
    subtest '9- Ireversible - withdrawal_supported' => sub {
        ...
        $allow_withdraw = $client_usd5->allow_paymentagent_withdrawal;
    ...
    subtest '10- Ireversible - withdrawal option NOT available' => sub {
        ...
        $allow_withdraw = $client_usd6->allow_paymentagent_withdrawal;
    ...
    subtest '11- crypto' => sub {
        ...
        $allow_withdraw = $client_crypto->allow_paymentagent_withdrawal;
