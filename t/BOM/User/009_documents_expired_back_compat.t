...
my $docs_mocker = Test::MockModule->new('BOM::Database::AutoGenerated::Rose::ClientAuthenticationDocument');
my $doc_status;

$docs_mocker->mock(
    'status',
    sub {
        return $doc_status // $docs_mocker->original('status')->(@_);
    });
