...
subtest 'has_funded' => sub {
    subtest 'CR001 - no funding' => sub {
        my $client = Client::Account::get_instance({loginid => 'CR0001'});
    ...
    subtest 'CR0005 - has funded' => sub {
        my $client = Client::Account::get_instance({loginid => 'CR0005'});
    ...
    subtest 'CR0006 - free loader' => sub {
        my $client = Client::Account::get_instance({loginid => 'CR0006'});
