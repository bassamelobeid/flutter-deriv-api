...
subtest 'buy' => sub {
    ...
    delete $params->{contract_parameters}{low_barrier};
    delete $params->{contract_parameters}{high_barrier};
    $params->{contract_parameters}{contract_type} = "CALL";
    ...
    is(
        $result->{longcode},
        'Win payout if Volatility 50 1Hz is strictly higher than entry spot at 2 minutes after contract start time.',
        'longcode is correct'
    );
