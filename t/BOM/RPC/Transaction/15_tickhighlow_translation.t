...
subtest 'audit_details tick names translations' => sub {
    ...
    check_results(
        $contract_high,
        '<LOC>Win payout if tick 5 of <LOC>Volatility 50 1Hz</LOC> is the highest among all <LOC>5</LOC> ticks.</LOC>',
        '<LOC>Start Time</LOC>',
        '<LOC>Entry Spot</LOC>',
    ...
    check_results(
        $contract_low,
        '<LOC>Win payout if tick 1 of <LOC>Volatility 50 1Hz</LOC> is the lowest among all <LOC>5</LOC> ticks.</LOC>',
        '<LOC>Start Time</LOC>',
