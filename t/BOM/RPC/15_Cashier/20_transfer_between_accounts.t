...
subtest 'validation' => sub {
    ...
    cmp_deeply $result,
        ...
        'accounts'            => bag({
                ...
                'demo_account'          => bool(0),
                'market_type'           => 'all',
                'landing_company_short' => $client_cr->landing_company->short,
            },
            {
                'currency'              => 'BTC',
                'balance'               => ignore(),
                ...
                'demo_account'          => bool(0),
                'market_type'           => 'all',
                'landing_company_short' => $cr_dummy->landing_company->short,
            }
        ),
        'stash'          => ignore(),
        'status'         => 1,
    ...
    subtest 'crypto to crypto' => sub {
        ...
        my $expected_result = {
            ...
            'accounts'            => bag({
                    ...
                    'transfers'             => 'all',
                    'market_type'           => 'all',
                    'landing_company_short' => $client_cr_ltc->landing_company->short,
                },
                {
                    'currency'              => 'ETH',
                    'balance'               => ignore(),
                    ...
                    'transfers'             => 'all',
                    'market_type'           => 'all',
                    'landing_company_short' => $client_cr_eth->landing_company->short,
                }
            ),
            'stash'          => ignore(),
            'status'         => 1,
    ...
    subtest 'crypto to stable' => sub {
        ...
        my $expected_result = {
            ...
            'accounts'            => bag({
                    ...
                    'transfers'             => 'all',
                    'market_type'           => 'all',
                    'landing_company_short' => $client_cr_usdc->landing_company->short,
                },
                {
                    'currency'              => 'BTC',
                    'balance'               => ignore(),
                    ...
                    'transfers'             => 'all',
                    'market_type'           => 'all',
                    'landing_company_short' => $client_cr_btc->landing_company->short,
                }
            ),
            'stash'          => ignore(),
            'status'         => 1,
        ...
        my $expected_result = {
            ...
            'accounts'            => bag({
                ...
                },
                {
                    ...
                    'transfers'             => 'all',
                    'market_type'           => 'all',
                    'landing_company_short' => $client_cr_ust->landing_company->short,
                }
            ),
            'stash'          => ignore(),
            'status'         => 1,
        ...
        $rpc_ct->result,
        {
            ...
            accounts            => bag({
                ...
                },
                {
                    ...
                    demo_account          => 0,
                    transfers             => 'all',
                    landing_company_short => $test_client->landing_company->short,
                })
        },
            ...
            $rpc_ct->call_ok('transfer_between_accounts', $params)->result,
            {
                ...
                accounts            => bag({
                    ...
                    },
                    {
                        ...
                        transfers             => 'all',
                        landing_company_short => $test_wallet_vr->landing_company->short,
                    })
            },
            'expected data in result'
        );
