...
subtest 'MT5' => sub {
    ...
    $rpc_ct->call_ok('mt5_new_account', $params)->has_no_error('no error for real mt5_new_account');
    ...
    cmp_bag(\@accounts, [ $test_client->loginid, 'MT'.$ACCOUNTS{'real\labuan_advanced'} ], "all real money accounts by empty $method call");
