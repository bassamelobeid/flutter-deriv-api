...
subtest 'get and set self_exclusion' => sub {
    ...
    is($c->tcall($method, $params)->{error}{details}{max_open_bets}, 'Please input a valid number.', 'don\'t allow decimals in open bets');
    $params->{args}{max_open_bets} = 99;
    $params->{args}{max_balance} = 9996.123;
    is($c->tcall($method, $params)->{error}{details}{max_balance}, 'Please input a valid number.', 'don\'t allow more than two decimals in max balance for this client');
    $params->{args}{max_balance} = 9996.12;
