...
subtest $method => sub {
    is_deeply($c->tcall($method, {token => '12345'}), [qw(USD EUR GBP AUD XBT)], 'invalid token will get all currencies');
    is_deeply(
        $c->tcall(
            $method,
            {
