...
subtest $method => sub {
    ...
    is(
        ...
        'Win payout if Volatility 50 1Hz is strictly higher than entry spot at 50 seconds after contract start time.',
    ...
    is(
        $result->{transactions}[0]{longcode},
        'Win payout if Volatility 100 1Hz is strictly higher than entry spot at 4 hours after contract start time.',
...
subtest $method => sub {
    ...
    $expect0->{longcode}  = 'Win payout if Volatility 50 1Hz is strictly higher than entry spot at 50 seconds after contract start time.';
