...
my $account_balance_limit = $client->get_limit({
    'for'      => 'account_balance',
    'currency' => 'USD',
});
is($account_balance_limit, 300000, 'balance limit = 300000');

my $daily_turnover_limit = $client->get_limit({
    'for'      => 'daily_turnover',
    'currency' => 'USD',
});
...
$account_balance_limit = $client->get_limit({
    'for'      => 'account_balance',
    'currency' => 'USD',
});
is($account_balance_limit, 111111, 'balance limit = 111111');

$daily_turnover_limit = $client->get_limit({
    'for'      => 'daily_turnover',
    'currency' => 'USD',
});
is($daily_turnover_limit, 222222, 'turnover limit = 222222');

$payout_limit = $client->get_limit({
    'for'      => 'payout',
    'currency' => 'USD',
});
