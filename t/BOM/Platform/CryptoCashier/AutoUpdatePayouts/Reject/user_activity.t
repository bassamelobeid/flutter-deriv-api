...
subtest 'BOM::Platform::CryptoCashier::AutoUpdatePayouts::Reject->user_activity' => sub {
    ...
    subtest 'MANUAL_VERIFICATION_REQUIRED' => sub {
        $mock->mock(
            user_payment_details => sub {
                return {
                    count                             => 2,
        ...
        is_deeply(
            ...
            "returns default tag: MANUAL_VERIFICATION_REQUIRED as crypto net deposit is greater than other payment methdod net deposit"
        );
        $mock->unmock_all();
    };
