...
subtest 'deposit page warning message' => sub {
    ...
    $warning_message = BOM::Platform::CryptoCashier::Iframe::Controller::deposit_page_warning_message($currency_code);
    is $warning_message,
        'To avoid losing your funds, please use the <strong>TRON (TRC20) network</strong> only. Other networks are not supported for tUSDT deposits.',
        'correct warning message for tUSDT/TRC20 currency';
