...
is_deeply $@,
    [
    BI003 => 'ERROR:  insufficient balance, need: 0.010000000000, #open_bets: 0, pot_payout: 0',
    ],
...
subtest 'batch_buy', sub {
    ...
    lives_ok {
        ...
        subtest 'testing result for ' . $loginid, sub {
            ...
            is $txn->{amount}, '-20.000000000000',  'txn amount';
            is $txn->{balance_after}, '4980.000000000000', 'txn balance_after';
        ...
        subtest 'testing result for ' . $loginid, sub {
            ...
            is $txn->{financial_market_bet_id}, $fmb->{id}, 'txn fmb id matches';
            is $txn->{amount}, '-20.000000000000',  'txn amount';
            is $txn->{balance_after}, '9980.000000000000', 'txn balance_after';
            is $txn->{staff_loginid}, '#CL001',    'txn staff_loginid';
