...
subtest 'Expect that all fields are the same after loading FROM account transfer record' => sub {
    ...
    cmp_ok $higher_lower->financial_market_bet_open_record->payout_price, '==', 200;
    cmp_ok $higher_lower->financial_market_bet_open_record->buy_price, '==', 20;
    cmp_ok $higher_lower->financial_market_bet_open_record->sell_price, '==', 40;
