...
is($legacy_bet->financial_market_bet_open_record->payout_price, formatnumber('amount', 'USD', $payout_price), 'payout_price');
is($legacy_bet->financial_market_bet_open_record->buy_price,    formatnumber('amount', 'USD', $buy_price),    'buy_price');
is($legacy_bet->financial_market_bet_open_record->sell_price,   formatnumber('amount', 'USD', $sell_price),   'sell_price');
