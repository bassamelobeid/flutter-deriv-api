...
is($touch_bet->financial_market_bet_open_record->payout_price,      sprintf('%.2f', $payout_price), 'payout_price');
is($touch_bet->financial_market_bet_open_record->buy_price,         sprintf('%.2f', $buy_price),    'buy_price');
is($touch_bet->financial_market_bet_open_record->sell_price,        sprintf('%.2f', $sell_price),   'sell_price');
