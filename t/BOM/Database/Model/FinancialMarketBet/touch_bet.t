...
cmp_ok($touch_bet->financial_market_bet_open_record->payout_price,  '==',$payout_price, 'payout_price');
cmp_ok($touch_bet->financial_market_bet_open_record->buy_price,     '==',$buy_price,    'buy_price');
cmp_ok($touch_bet->financial_market_bet_open_record->sell_price,    '==',$sell_price,   'sell_price');
