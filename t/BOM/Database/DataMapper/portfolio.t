...
#  /> su nobody -c 'prove /home/git/bom/cgi/t/Portfolio/001_portfolio.t'
#
# to see tests that are passed and comments add -v flag, i.e use:
#  /> su nobody -c 'prove -v /home/git/bom/cgi/t/Portfolio/001_portfolio.t'
#
...
#  /> su nobody -c "prove -v /home/git/bom/cgi/t/*"
##########################################################################################################
