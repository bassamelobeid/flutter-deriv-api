...
cmp_ok(scalar @{$clientdb->fetchall_arrayref('select * from bet.get_open_bets_of_account(?,?,?)', ['CR0021', 'USD', 'false'])}, '==', 0, 'check qty open bet = 0');
...
cmp_ok(scalar @{$clientdb->fetchall_arrayref('select * from bet.get_open_bets_of_account(?,?,?)', ['CR0021', 'USD', 'false'])}, '==', 1, 'check qty open bet = 1');
...
cmp_ok(scalar @{$clientdb->fetchall_arrayref('select * from bet.get_open_bets_of_account(?,?,?)', ['CR0021', 'USD', 'false'])}, '==', 2, 'check qty open bet = 1');
...
'buy higher lower relative barrier bet';
cmp_ok(scalar @{$clientdb->fetchall_arrayref('select * from bet.get_open_bets_of_account(?,?,?)', ['CR0021', 'USD', 'false'])}, '==', 3, 'check qty open bet = 2');
...
isnt scalar sell({
    ...
    undef, 'sell 1 bet';
cmp_ok(scalar @{$clientdb->fetchall_arrayref('select * from bet.get_open_bets_of_account(?,?,?)', ['CR0021', 'USD', 'false'])}, '==', 1, 'check qty open bet = 0');
