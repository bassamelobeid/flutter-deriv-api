...
subtest 'lookback' => sub {
    ...
    is $reporter->output_file_path(), '/db/myaffiliates/binary/lookback_' . $processing_date->date_yyyymmdd . '.csv', 'Output file path is correct';
    ...
    is_deeply([sort @header_row], [qw/client_loginid date exchangerate lookback_commission stake /], 'first row is header row - got correct header');
    ...
    ok $row[3], 'has lookback commission price';
