...
subtest 'process' => sub {
    ...
    is_deeply(
        ...
        [
            sort
                qw/email_consent register_details email_statement sync_user_to_MT5 store_mt5_transaction new_financial_mt5_signup anonymize_client send_mt5_disable_csv document_upload ready_for_authentication account_closure client_verification social_responsibility_check/
        ],
