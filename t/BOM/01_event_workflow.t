    ...
    cmp_deeply(
        ...
        bag(
            qw/email_statement sync_user_to_MT5
                ...
                update_loginid_status bulk_affiliate_loginids_sync p2p_update_local_currencies mt5_deriv_auto_rescind mt5_archive_restore_sync/
        ),
    ...
    cmp_deeply(
        ...
        bag(
            qw/multiplier_hit_type multiplier_near_expire_notification multiplier_near_dc_notification
                ...
                risk_disclaimer_resubmission unknown_login derivx_account_deactivated poa_verification_failed_reminder/
        ),
        'Correct number of actions that can be emitted'
    );
