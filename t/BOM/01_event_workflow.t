    ...
    cmp_deeply(
        ...
        bag(
            qw/email_statement sync_user_to_MT5
                ...
                crypto_withdrawal idv_webhook_received idv_configuration_disable_provider idv_configuration_enable_provider idv_configuration_requested idv_dynamic_settings_updated
