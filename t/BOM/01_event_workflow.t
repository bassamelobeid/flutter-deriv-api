    ...
    cmp_deeply(
        ...
        bag(
            qw/email_statement sync_user_to_MT5
                ...
                affiliate_sync_initiated withdrawal_limit_reached payops_event_update_account_status
    ...
    cmp_deeply(
        ...
        bag(
            qw/multiplier_hit_type multiplier_near_expire_notification multiplier_near_dc_notification
                ...
                risk_disclaimer_resubmission unknown_login derivx_account_deactivated poa_verification_failed_reminder professional_status_requested/
        ),
        'Correct number of actions that can be emitted'
    );
