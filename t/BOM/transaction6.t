...
subtest 'buy a bet', sub {
    ...
    lives_ok {
        ...
        subtest 'transaction row', sub {
            ...
            is $trx->{amount} + 0, -4.3, 'amount';
            is $trx->{balance_after} + 0, 5000 - 4.3, 'balance_after';
        ...
        subtest 'fmb row', sub {
            ...
            is $fmb->{buy_price} + 0, 4.3, 'buy_price';
            ...
            like $fmb->{remark},   qr/\btrade\[4\.30000\]/, 'remark';
