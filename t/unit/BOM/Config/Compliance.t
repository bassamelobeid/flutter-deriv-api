...
subtest 'get_risk_thresholds' => sub {
    ...
    throws_ok{BOM::Config::Compliance->get_risk_thresholds($invalid_threshold_type)} qr/Invalid threshold type $invalid_threshold_type/, 'Un-supported threshold type is used';

    my $mocked_runtime = Test::MockModule->new("App::Config::Chronicle");
    my $mocked_compliance_config = '{"CR": {"yearly_standard": 10000, "yearly_high": 20000}, "MF": {"yearly_standard": 10000, "yearly_high": 20000} }';
...
subtest 'validate_risk_thresholds' => sub {
    ...
    throws_ok {BOM::Config::Compliance->validate_risk_thresholds(%$input_args)} qr/$expected/, "Standard threshold is higher than high risk threshold";
};
