...
tidy:
	...
	find . -not -path "./.git*" -not -path "./srp*" -name '*.p[lm]' -o -name '*.t' | grep -v 'AutoGenerated' | xargs perltidier -pro=/home/git/regentmarkets/cpan/rc/.perltidyrc --backup-and-modify-in-place -bext=tidyup
