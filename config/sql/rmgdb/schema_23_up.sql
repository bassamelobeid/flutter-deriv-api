...
CREATE TRIGGER watched_fmbo_trigger AFTER INSERT ON bet.financial_market_bet_open FOR EACH ROW EXECUTE PROCEDURE insert_daily_aggregates();
CREATE TRIGGER watched_fmb_trigger AFTER INSERT ON bet.financial_market_bet FOR EACH ROW EXECUTE PROCEDURE update_daily_aggregates();
